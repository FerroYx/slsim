...
class Kilonova:
    ...
    Redback can be found at https://redback.readthedocs.io/en/latest/.
    """
    ...
    def __init__(
            ...
            **kwargs 
            ...
            if modeldir is not None: 
                ...
                raise NotImplementedError("External kilonova model files are not supported yet.") 
            else: 
                # use Redback built-in kilonova model, e.g. mosfit_kilonova 
                if not hasattr(kilonova_models, model_name): 
                    raise ValueError( f"{model_name} is not available in " 
    ...
    def get_apparent_magnitude(self, time, band, zpsys="AB"): 
        ...
        return self._model( 
            ...
            bands=band, output_format="magnitude", 
